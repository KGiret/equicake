	...
	public function add() {
		if ($this->request->is('post')) {
			...
			if ($this->Video->save($this->request->data)) {
				return $this->flash(__('The video has been saved.'), array('action' => 'index'));
			}
		}
 ...
 */
	public function delete($id = null) {
		...
		if ($this->Video->delete()) {
			return $this->flash(__('The video has been deleted.'), array('action' => 'index'));
		} else {
			return $this->flash(__('The video could not be deleted. Please, try again.'), array('action' => 'index'));
		}
	}}
